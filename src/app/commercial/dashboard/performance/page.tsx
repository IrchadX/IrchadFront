  ...
  return (
    <div className="container mx-auto p-4 flex flex-col gap-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <KpiCard
          title="Marge brute"
          value={grossMarginData ? formatCurrency(grossMarginData.grossMargin) : "Chargement..."}
          icon={TrendingUp}
          iconColor="#16DBCC"
          color="#DCFAF8"
        />
        <KpiCard
          title="Marge nette"
          value={netMarginData ? `${netMarginData.netMarginPercentage.toFixed(1)}%` : "Chargement..."}
          icon={DollarSign}
          iconColor="#FFBB38"
          color="#FFF5D9"
        />
        <KpiCard
          ...
          value={grossMarginData ? formatCurrency(grossMarginData.cogs) : "Chargement..."}
          icon={TrendingDown}
          iconColor="#FF82AC"
          color="#FFE0EB"
        />
        <KpiCard
          title="Charges"
          value={netMarginData ? formatCurrency(netMarginData.expenses) : "Chargement..."}
          icon={Receipt}
          iconColor="#9F9FF8"
          color="#F0F0FF"
        />
