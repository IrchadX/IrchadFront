...
export default function Login() {
  ...
  return (
    <div
      ...
      <div className="w-full xl:w-[48%] m-8 xl:m-0 flex flex-col justify-center items-center px-[25px] sm:px-[50px] md:px-[107px] gap-[60px] xl:overflow-hidden xl:h-full z-20">
