...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent data-[state=open]:bg-accent dark:focus:bg-gray-700 dark:data-[state=open]:bg-gray-700",
      "dark:text-gray-100 dark:hover:text-white",
      inset && "pl-8 rtl:pl-0 rtl:pr-8",
      className
    )}
    {...props}>
    {children}
